...
var SEARCH_URL      = ROOT_PATH+"/sys/log/getLogAccMenu.do";
...
function loadGrid() {
    $(GRID_NAME).jqGrid({
        ...
        mtype        : 'GET',
        caption      : "메뉴별접속통계",
        colNames     : ["메뉴","접속횟수","마지막 접속일","개인화 서비스 이용 인원"],
        postData     : getSearchPostData(),
        colModel:[
            {name:'menuNm',         index:'menu_nm' ,           width:150, editable:false, sortable:false, align:"left"},
            ...
            {name:'personUserCnt',  index:'person_user_cnt' ,   width:110, editable:false, formatter:"integer",  sortable:false, align:"right"},
        ],
        rowNum:10,
        rowList:[5,10,15],
        height: 276,
...
function getSearchPostData(){
    var postData = {
            ...
            srchMenuNm     : $("#srchMenuNm").val(),
            srchPersonUser : $("#srchPersonUser").val()
    }
...
function doSearch(){
    ...
    $("#srchMenuNm"    ).val($("#srchMenuNmTemp"    ).val());
    $("#srchPersonUser").val($("#srchPersonUserTemp").val());
