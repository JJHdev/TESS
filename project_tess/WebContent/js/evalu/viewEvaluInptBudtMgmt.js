...
function goView() {
	...
	var nextEvaluCode = $("#nextEvaluCode").val();
	
	if(nextEvaluCode == "AS30"){
		var trgtUrl = "/evalu/viewEvaluFinlBudtMgmt.do";
		$("#evaluDetailCode").val("");
	}else {
		var trgtUrl = "/evalu/viewEvaluInptBudtMgmt.do";
		$("#evaluDetailCode").val(nextEvaluCode);
	}
