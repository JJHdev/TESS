	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{ 
 			sUrl  : 'http://localhost:8080/comm/editorfileUpload.do',	//샘플 URL입니다.
//			sUrl  : 'http://125.140.104.65:8080/comm/editorfileUpload.do',	//샘플 URL입니다.
 	        sCallback : '/se2/popup/quick_photo/callback.jsp',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
...
// 파일 업로드 시 리사이징 하는 파일 업로드(하다 실패)	 
// 	    		alert(2);
//                aResult[0] = oCustomEvent.htResult; 
//                var tempimg = new Image(); 
//                tempimg.src = aResult[0].sFileURL; 
//                alert(tempimg.width);
//                tempimg.onload = function() { 
//                        if(tempimg.width > 800){
//                        	aResult[0].nWidth = 600; 
//                        }else{
//                        	aResult[0].nWidth = tempimg.width; 
//                        }
//                        if(tempimg.height > 768){
//                        	aResult[0].nHeight = 480; 
//                        }else{
//                        	aResult[0].nHeight = tempimg.height; 
//                        }
//                         setPhotoToEditor(aResult); 
//                         //버튼 비활성화 
//                         goReadyMode();  
