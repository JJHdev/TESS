		...
		<table class="searchTable"  >
			...
			<tbody>
				...
				<tr>
					...
					<td><form:input path="userNm"  maxlength="25" class="form-control input-sm" title="사용자 명"/></td>
					<td rowspan="2"><a class="btn btn-smRed btn-login" href="#" data-toggle="modal" data-target="" id="cfrmBtn">확인</a></td><!-- 아이디 찾기 성공 -->
					<!-- <a class="btn btn-smRed btn-login" href="#" data-toggle="modal" data-target="#idSearchErrorModal">확인</a> --><!-- 아이디 찾기 실패 -->
				</tr> 
				<tr>
					<th><i class="icon-ic_email"> </i>이메일</th>
					<td>
							<table class="searchSubTable" ><tr>
								<td><input type="text" class="form-control input-sm" id="email1"  name="email1"  maxlength="30"  style="width: 82px;" title="담당자 E-mail1"></td>
								<td>&nbsp;@&nbsp;</td>
								<td><input type="text" class="form-control input-sm marginRright12" id="email2" name="email2" style="width: 120px;"  maxlength="30" title="담당자 E-mail2"/></td>
								<td>
			...
			<table>
				...
				<tbody>
					<tr>
						...
						<td class="subject">회원님의 아이디는 <strong class="textRed"><span id="srchUserId">abcds</span> </strong>입니다.</td>
					</tr>
				</tbody>
			</table>
			
			<div class="text-center" style="margin: 40px 0;">
				<a href="/login.do"><button type="button" class="btn btn-green marginRright4" style="width:100px;"><i class="icon-ic_dvr"> </i>로그인</button></a>
				<a href="/memb/viewMembFindPwd.do"><button type="button" class="btn btn-green marginRright4" style="width:130px;"><i class="icon-ic_lock_outline"> </i>비밀번호 찾기</button></a>
				<a href=""><button type="button" class="btn btn-red" style="width:100px;" data-dismiss="modal"><i class="icon-ic_refresh"> </i>취소</button></a>
        	</div>
			...
			<table>
				...
				<tbody>
					<tr>
						...
						<td class="subject">회원님의 임시비밀번호는 <strong class="textRed">abcds</strong>입니다.</td>
					</tr>
				</tbody>
			</table>
			
			<div class="text-center" style="margin: 40px 0;">
				<button type="button" class="btn btn-green marginRright4" ><i class="icon-ic_dvr"> </i>로그인</button>
