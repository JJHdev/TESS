...
<app:layout mode="header" type="error"/>
	...
	<div style="margin-top:1px; width:968px; border:1px solid #cccccc; background:#f5f5f5; padding:50px 60px;">
		<div style="text-align:center; font-family:Tahoma, Geneva, sans-serif; font-size:22px; color:#000000; margin-bottom:40px;">404 page not found (요청한 페이지를 찾을 수 없습니다.)</div>
	</div>
	<center>
