...
<app:layout mode="header" type="error"/>
	...
	<div style="text-align:center;"><img src='<c:url value="/images/error/error_title_02.jpg"/>'alt=""></div>
	...
	<div style="margin-top:1px; width:968px; border:1px solid #cccccc; background:#f5f5f5; padding:50px 60px;">
		<!-- <div style="text-align:center; font-family:Tahoma, Geneva, sans-serif; font-size:22px; color:#000000; margin-bottom:40px;">MESSAGE</div> -->
