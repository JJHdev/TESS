                                ...
                                <form>
                                    <div class="form-group search-form">
                                        <ul class="g-search">
                                            ...
                                            <li class="g-search-col w50"><input type="text" class="g-search-input-txt"  title="사업정보 검색" placeholder="사업정보(사업명, 사업개요, 사업유형)" id="search-busiName"></li>
                                            <%--<li class="g-search-col w25"><input type="text" class="g-search-input-txt" title="지역명 검색" placeholder="지역명"></li>--%>
                                        </ul>
                                        <div class="g-search-btn">
                                            <a onclick="search_btn()" title="검색시작">검색</a>
                                        </div>
                                    </div>
                                </form>
                                            ...
                                            <ul class="i-search">
                                                ...
                                                <li class="i-search-col w50">
                                                    ...
                                                    <div class="i-search-result" id="i-search-eval">
                                                        <div class="i-search-item active"><a title="전체"  onclick="selectEval(this, '', '전체')">전체</a></div>
                                                        <c:forEach items="${busiStageComboList}" varStatus="idx" var="type">
                                                            <div class="i-search-item "><a title="전체" onclick="selectEval(this, '${type.code}', '${type.codeNm}' )">${type.codeNm}</a></div>
                                                        </c:forEach>
                                                    </div>
                                                </li>
                                            </ul>
