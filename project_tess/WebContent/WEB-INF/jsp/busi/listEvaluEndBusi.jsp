	    ...
	    <div class="contents" style="padding:0px;">
	            ...
	            <div id="srchCondArea">
					...
					<input type="hidden" name="srchEvaluGubun" id="srchEvaluGubun"
                   	...
                   	<input type="hidden" name="srchEvaluCommit" id="srchEvaluCommit"
                    	   value='<c:out value="${paramMap.srchEvaluCommit}"/>'/>
	            </div>
	                                ...
	                                <form>
	                                    <div class="form-group search-form">
	                                        <ul class="g-search">
	                                            ...
	                                            <li class="g-search-col w50"><input type="text" class="g-search-input-txt"  title="사업정보 검색" placeholder="사업명" id="search-busiName"></li>
