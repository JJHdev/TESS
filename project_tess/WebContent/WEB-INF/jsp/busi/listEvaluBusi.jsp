	    ...
	    <div class="contents" style="padding:0px;">
	            ...
	            <div id="srchCondArea">
                    ...
                    <input type="hidden" name="srchEvaluGubun" id="srchEvaluGubun"
                    	   value='<c:out value="${paramMap.srchEvaluGubun}"/>'/>
                   	<input type="hidden" name="srchEvaluStage" id="srchEvaluStage"
                    	   value='<c:out value="${paramMap.srchEvaluStage}"/>'/>
	            </div>
	            ...
	            <div class="contents-wrap">
	                <div class="wrapper sub"> <!-- 메인페이지 : 'main', 서브페이지 : 'sub' 클래스 추가 -->
	                    <div class="container">
	                        ...
	                        <div class="row">
	                            <div class="col-md-12">
	                                <h3 class="page-title">2019 평가사업</h3>
	                                <!-- Contents -->
	                                <form>
	                                    <div class="form-group search-form">
	                                        <ul class="g-search">
	                                            ...
	                                            <li class="g-search-col w50"><input type="text" class="g-search-input-txt"  title="사업명 검색" placeholder="사업명" id="search-busiName"></li>
	                                            <%--<li class="g-search-col w25"><input type="text" class="g-search-input-txt" title="지역명 검색" placeholder="지역명"></li>--%>
	                                        </ul>
	                                        <div class="g-search-btn">
	                                            <a onclick="search_btn(0)" title="검색시작">검색</a>
	                                        </div>
	                                    </div>
	                                </form>
	                                ...
	                                <div class="search-acd" id="searchItem" role="tablist" aria-multiselectable="true">
	                                            ...
	                                            <ul class="i-search">
	                                                ...
	                                                <li class="i-search-col w50">
	                                                    ...
	                                                    <div class="i-search-result" id="i-search-eval">
	                                                        <div class="i-search-item selected"><a title="전체"  onclick="selectEvaluStage(this, '', '전체')">전체</a></div>
	                                                        <c:forEach items="${busiStageComboList}" varStatus="idx" var="type">
	                                                            <div class="i-search-item "><a title="전체" onclick="selectEvaluStage(this, '${type.code}', '${type.codeNm}' )">${type.codeNm}</a></div>
	                                                        </c:forEach>
	                                                    </div>
	                                                </li>
	                                            </ul>
	                                            ...
	                                            <ul class="i-search">
	                                                ...
	                                                <li class="i-search-col w50">
	                                                    <div class="i-search-result" id="i-search-busiCate">
	                                                        <div class="i-search-item selected" id="projecttype0"><a href="#" title="전체">전체</a></div>
	                                                    </div>
	                                                </li>
	                                            </ul>
	                                        </div>
	                                    ...
	                                    <div class="search-words">
	                                        ...
	                                        <div class="searach-word" id="search_eval">[평가]&nbsp;전체</div>
	                                        <div class="searach-word" id="search_area">[지역]&nbsp;전체</div>
	                                        <div class="searach-word" id="search_type">[사업]&nbsp;전체</div>
	                                    </div>
