<%
 /****************************************************************************************
***	ID					: listRoleByProgMgmt.jsp
***	Title				: Role by program Management Screen
***	Description	: Role by program Management Screen
***
***	-----------------------------    Modified Log   --------------------------------------
***	ver				date						author					description
***  -----------------------------------------------------------------------------------------
***	1.0			2011-09-29				ntarget					First Coding.
*****************************************************************************************/
%>
...
// Grid Caption Name.
var caption_detail	= '<spring:message code="title.adm.header.roleProg"/>';
...
<div class="group_wrap_02">
    <div style="width:90%; padding:0 0 0 10px;">
        <table class="style_search_01">
            ...
            <tr>
                <th><spring:message code="title.adm.schRole"/></th>
                <td>
                    <form:select path="roleId" items="${roleList}"  multiple="false" cssClass="down_menu" onchange="fn_search();" />
                </td>
            </tr>
