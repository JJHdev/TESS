			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h3 class="page-title">자주묻는질문 수정</h3>
						...
						<table class="evtdss-form-table noMargin">
							...
							<%--<tr>--%>
								...
								<%--<td>--%>
										<%--&lt;%&ndash;<input type="file" class="regi-file-input" id="upFile1">&ndash;%&gt;--%>
										<%--&lt;%&ndash;<div class="regi-file">등록파일 없음</div>&ndash;%&gt;--%>
						...
						<div class="grid-head">
							...
							<button type="button" class="grid-print" id="_delBtn"><i class="glyphicon glyphicon-remove"></i> 삭제</button>
