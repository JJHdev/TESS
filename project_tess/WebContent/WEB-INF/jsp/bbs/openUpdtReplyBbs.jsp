...
<form:form commandName="model" id="model" method="post" >
	...
	<input type="hidden" name="mode" id="mode" value="repupdt"/>
	...
	<input type="hidden" name="parent_bbs_no" id="parent_bbs_no" value="${resultView.bbsNo }"/>
	...
	<caption>글작서어 양식</caption>
		...
		<tr class="top2">
			...
			<td colspan="3" class="rightNoLine">
				<form:input title="제목" id="bbsSubject" path="bbsSubject" class="form-control input-sm" cssStyle="width: 95%" />
			</td>
		</tr>
		<tr class="bottom">
			<th scope="row" class="leftNoLine">구분</th>
			<td class="rightNoLine">
				<form:select title="분류" class="form-control input-sm" path="docuKind" id="docuKind">
			...
			<th scope="row">등록자</th>
			<td class="rightNoLine"><input type="text" title="작성자" id="userNm" class="form-control input-sm" value="${modelMap.gsUserNm}"  disabled /></td>
		</tr>
		<tr class="bottom">
			<td colspan="4" class="leftNoLine rightNoLine" style="padding:20px 0;">
				<form:textarea id="bbsDesc" title="내용" path="bbsDesc" cssStyle="width:96%; height:150px;"></form:textarea>
			</td>
		</tr>
		</tbody>	
	</table>
