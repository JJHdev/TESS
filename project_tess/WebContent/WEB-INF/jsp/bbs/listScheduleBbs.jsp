					...
					<div class="col-md-12">
						...
						<div class="grid-head">
							...
							<button type="button" class="grid-print green" title="새글작성" id="openRegiBtn"><i
									class="glyphicon glyphicon-plus"></i> 새일정
							</button>
							</c:if>
							...
							<div class="grid-filter">
								<div class='col-sm-12 noPadding'>
									<form:input id="search_word" path="search_word" type="text" title="검색어" label="검색어"
						...
						<div class="table-wrap">
							<table summery="일정게시판 목록이며 제목을 클릭하여 상세내용을 볼 수 있습니다.">
							<caption>일정게시판</caption>
							<colgroup>
                            	<col />
                            	<col />
                            	<col />
							...
							<tbody>
								<c:forEach items="${pageList }" varStatus="idx" var="item">
									<tr class="notice">
										...
										<td class="fix-width date"><c:out value="${item.startDate}"/>
										<td class="">
