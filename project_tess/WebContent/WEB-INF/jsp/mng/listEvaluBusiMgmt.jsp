<%--
*******************************************************************************
***    명칭: listEvaluBusiMgmt.jsp
***    설명: [관리자] 평가사업관리 > 평가사업목록 화면
***
***    -----------------------------    Modified Log   ---------------------------
***    버전        수정일자        수정자        내용
*** ---------------------------------------------------------------------------
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="grid-head">
									...
									<button class="grid-print green" title="신규등록" data-grid-control="open-mgtn"><i class="glyphicon glyphicon-plus"></i> 평가사업등록</button>
                                </div>
