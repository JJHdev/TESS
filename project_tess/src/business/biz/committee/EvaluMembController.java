...
/**
 * Program Name    : EvaluMembController
...
public class EvaluMembController extends BaseController {
    
    @Autowired
    private EvaluMembService evaluMembService;
     ...
     * @throws Exception
     */
    @RequestMapping(value="/committee/listEvaluMbrMgmt.do")
    public String listEvaluMbrMgmt(HttpServletRequest request, ModelMap model)
        ...
        return "committee/listEvaluMbrMgmt";
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value="/committee/regiEvaluMbrCommit.do")
    public String regiEvaluMbrCommit(HttpServletRequest request, ModelMap model)
        ...
        return "committee/regiEvaluMbrCommit";
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value="/committee/saveCommitMembInfo.do")
    public String saveCommitMembInfo(HttpServletRequest request, ModelMap model)
        ...
        try {
            ...
            // DB 작업 부분
            //------------------
            evaluMembService.saveCommitMembInfo(paramMap, procType);
            evaluMembService.saveCommitMembField(paramMap, procType);
        ...
        return "redirect:/committee/listEvaluMbrMgmt.do";
    }    
     ...
     * @throws Exception
     */
    @RequestMapping(value="/committee/updateCommitMembInfo.do")
    public String updateCommitMembInfo(HttpServletRequest request, ModelMap model)
            throws Exception {
    	logger.debug("/committee/updateCommitMembInfo.do");
        //---------------------------------------------
        //Default Value Setting
        String method       = getMethodName(new Throwable());
        Map paramMap = setMappingValues(request, method);
     ...
     * @throws Exception
     */
    @RequestMapping("/committee/getMembCheckIdDupl.do")
    public ModelAndView getMembCheckIdDupl(HttpServletRequest request, ModelMap model)
        ...
        try {
        	//아이디 중복 검사
        	 int duplCnt = evaluMembService.viewMembCheckDuplUserId(paramMap);
    ...
    */
    ...
    @RequestMapping("/committee/getEvaluMbrMgmt.do")
    public ModelAndView getEvaluMbrMgmt(HttpServletRequest request, ModelMap model)
        ...
        list = evaluMembService.listEvaluMbrMgmt(paramMap, CURR_PAGE, PAGE_SIZE);
        Map returnMap   = new HashMap();
     ...
     * @throws Exception
     */
    @RequestMapping("/committee/viewEvaluMbrCommit.do")
    public String viewEvaluMbrCommit(HttpServletRequest request, ModelMap model)
        ...
        Map mastMap =  evaluMembService.viewEvaluMbrCommit(paramMap);
        // default domain setting
        EvaluMbrMgmtDomain evaluMbrMgmtDomain = new EvaluMbrMgmtDomain();
        ...
        return "committee/viewEvaluMbrCommit";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/committee/getEvaluBusiList.do")
    public ModelAndView getEvaluBusiList(HttpServletRequest request, ModelMap model)
        ...
        PaginatedArrayList list = null;
        list = evaluMembService.listEvaluBusiList(paramMap, CURR_PAGE, PAGE_SIZE);
        Map returnMap   = new HashMap();
        returnMap.put("pageGridList", list);
        returnMap.put("Total"       , list.getTotalSize());
    ...
    private void formObject(Map paramMap, String method) throws Exception {
        ...
        if (method.equalsIgnoreCase("listEvaluMbrMgmt")) {
        ...
        } else if (method.equalsIgnoreCase("regiEvaluMbrCommit") || method.equalsIgnoreCase("viewEvaluMbrCommit")) {
            ...
            List fieldArtList = commService.listCode(paramMap);
            request.setAttribute("fieldArtList", fieldArtList) ;
            
            // 전문 분야별 코드 리스트(문화산업)
            paramMap.put("parentCode", "FT03");
            List fieldIndstList = commService.listCode(paramMap);
            request.setAttribute("fieldIndstList", fieldIndstList) ;
            ...
            List fieldEtcList = commService.listCode(paramMap);
            request.setAttribute("fieldEtcList", fieldEtcList) ;
