package business.biz.busi.domain;
 ...
 *
 */
public class EvaluBusiDomain extends BaseModel {
    ...
    private String evaluStage	; // 평가단계
    private String evaluGubun	; // 평가단계연도
	...
	public String getEvaluGubun() {
		return evaluGubun;
	}
	public void setEvaluGubun(String evaluGubun) {
		this.evaluGubun = evaluGubun;
	}
